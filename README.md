Getting started with SingleStore and C# Dapper ORM
==================================================


Whether you're using an ORM like Entity Framework or a light-weight ORM like Dapper, you can get started with SingleStore (formerly MemSQL) fast. Here's an introductory sample of using SingleStore with C#. This sample includes Dapper running all the CRUD methods: Create, Read by id, Read all, Update, and Delete.
